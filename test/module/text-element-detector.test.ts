...
test('When_ExecuteTextElementDetectorOnMerlinP11_Except_Success', async () => {
    ...
    const detector = new TextElementDetector(lines, words);
    const textElements = detector.execute();
